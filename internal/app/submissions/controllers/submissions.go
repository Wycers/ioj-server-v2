...
func (d *DefaultController) CreateSubmission(c *gin.Context) {
...
func (d *DefaultController) GetSubmission(c *gin.Context) {
...
func New(logger *zap.Logger, s services.SubmissionsService) Controller {
