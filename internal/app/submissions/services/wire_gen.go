...
func CreateSubmissionsService(cf string, sto repositories.Repository, sto2 repositories2.Repository) (SubmissionsService, error) {
	...
	submissionsService := NewSubmissionService(logger, sto, sto2)
